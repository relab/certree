...
interface NodeInterface {
    event NodeAdded(address indexed createdBy, address indexed nodeAddress, Role role);
     ...
     */
    function verifyCredentialRoot(address subject, bytes32 root) external view returns (bool);
}
